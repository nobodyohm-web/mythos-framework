---
name: optimizer
description: Performance specialist. Delegate when latency, throughput, memory, or cost are out of budget. Profiles first, then optimizes the bottleneck. Returns measured before/after numbers.
